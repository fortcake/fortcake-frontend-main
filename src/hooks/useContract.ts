...
const IUniswapV2PairABI = IUniswapV2PairAbi.abi;
/**
...
export const useTradingCompetitionContractV2 = (
...
export const useChainlinkOracleContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getChainlinkOracleContract(library.getSigner()),
    [library]
  );
};
...
export const useSpecialBunnyCakeVaultContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getBunnySpecialCakeVaultContract(library.getSigner()),
    [library]
  );
};
...
export const useSpecialBunnyPredictionContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getBunnySpecialPredictionContract(library.getSigner()),
    [library]
  );
};
...
export const useBunnySpecialLotteryContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getBunnySpecialLotteryContract(library.getSigner()),
    [library]
  );
};
...
export const useBunnySpecialXmasContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getBunnySpecialXmasContract(library.getSigner()),
    [library]
  );
};
...
export const useAnniversaryAchievementContract = () => {
  const { library } = useActiveWeb3React();
  return useMemo(
    () => getAnniversaryAchievementContract(library.getSigner()),
    [library]
  );
};
...
export const useFarmAuctionContract = () => {
  ...
  return useMemo(
    () => getFarmAuctionContract(account ? library.getSigner() : library),
    [library, account]
  );
};
