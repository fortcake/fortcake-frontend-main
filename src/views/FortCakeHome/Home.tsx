    ...
    <Box overflowX="hidden" position="relative">
        ...
        <SectionFlex className="grid">
          <PageHeader>
            <Flex alignItems="center" mb={isMobile ? '40px' : '20px'} justifyContent="space-between">
              ...
              <LazyImage src={CakeImage.src} width={100} height={78} className="imgShowOnMobile" />
            </Flex>
          ...
          <LazyImage src={CakeImage.src} width={460} height={360} className="imgHideOnMobile" />
        </SectionFlex>
      ...
      <Section>
        <SectionFlex className="grid tokenomics small">
          <LazyImage src={Token.src} width={460} height={460} />
          <Box>
            <Heading as="h2" scale="xl">
              Quick Start Guide
            </Heading>
      ...
      <Section>
        <SectionFlex className="grid tokenomics">
          ...
          <LazyImage src={Tokenomics.src} width={500} height={374} />
        </SectionFlex>
        <SectionFlex className="grid tokenomics reversed">
          <LazyImage src={GamePreview.src} width={410} height={310} />
          <Box>
            <Heading as="h2" scale="xl">
              Play
            </Heading>
        ...
        <SectionFlex className="grid tokenomics">
          ...
          <LazyImage src={SwapPreview.src} width={450} height={316} />
        </SectionFlex>
        <SectionFlex className="grid tokenomics reversed">
          <LazyImage src={Staking.src} width={400} height={320} />
          <Box>
            <Heading as="h2" scale="xl">
              Earn (Coming Soon)
            </Heading>
